...
> 💡 **More examples:** Over 60 examples of using various aspects of the environment are collected in the files **[examples2.md](examples2.md)** (for Python 2) and **[examples3.md](examples3.md)** (for Python 3). Most examples are identical for both versions.
